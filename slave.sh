...
/usr/local/smokeping/bin/smokeping --master-url=http://127.0.0.1:9006/ --cache-dir=/usr/local/smokeping/cache/ --shared-secret=/usr/local/smokeping/etc/secrets --slave-name=SLAVE_CODE &
